! function() {
    ...
    })(JSON.parse('{"31a2d1f951064f7a":"controller.3ea72c78.js","f96e2009a94b89d7":"icons.c781f215.svg"}'));
    var n, o = {},
        i = function(t) {
    ...
    function Zv(t, e) {
        return function(t) {
            ...
            if (!t) return;
            if ("string" == typeof t) return tg(t, e);
            var r = Object.prototype.toString.call(t).slice(8, -1);
            "Object" === r && t.constructor && (r = t.constructor.name);
            if ("Map" === r || "Set" === r) return Array.from(t);
            if ("Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return tg(t, e)
        }(t, e) || function() {
    ...
    var ag, ug = {
        ...
        sg = function() {
            var t = rg(regeneratorRuntime.mark((function t(e) {
                var r;
                return regeneratorRuntime.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return t.prev = 0, t.next = 3, Qv("".concat("https://forkify-api.herokuapp.com/api/v2/recipes/").concat(e, "?key=").concat("a781d6e1-0fbe-47e4-b586-c2eb1c8c7ddc"));
                        case 3:
                            r = t.sent, ug.recipe = cg(r), ug.bookmarks.some((function(t) {
                                return t.id === e
                            })) ? ug.recipe.bookmarked = !0 : ug.recipe.bookmarked = !1, console.log(ug.recipe), t.next = 13;
                            break;
                        case 9:
        ...
        fg = function() {
            var t = rg(regeneratorRuntime.mark((function t(e) {
                ...
                return regeneratorRuntime.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return t.prev = 0, ug.search.query = e, t.next = 4, Qv("".concat("https://forkify-api.herokuapp.com/api/v2/recipes/", "?search=").concat(e, "&key=").concat("a781d6e1-0fbe-47e4-b586-c2eb1c8c7ddc"));
                        case 4:
                            r = t.sent, console.log(r), ug.search.results = r.data.recipes.map((function(t) {
                                return og({
                                    id: t.id,
                                    title: t.title,
        ...
        lg = function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ug.search.page;
            ug.search.page = t;
            var e = (t - 1) * ug.search.resultsPerPage,
                r = t * ug.search.resultsPerPage;
            return ug.search.results.slice(e, r)
        },
        hg = function() {
            localStorage.setItem("bookmarks", JSON.stringify(ug.bookmarks))
        },
        pg = function(t) {
            ug.bookmarks.push(t), t.id === ug.recipe.id && (ug.recipe.bookmarked = !0), hg()
        };
    (ag = localStorage.getItem("bookmarks")) && (ug.bookmarks = JSON.parse(ag));
    var dg, vg = function() {
            var t = rg(regeneratorRuntime.mark((function t(e) {
                var r, n, o;
                return regeneratorRuntime.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return t.prev = 0, r = Object.entries(e).filter((function(t) {
                                return t[0].startsWith("ingredient") && "" !== t[1]
                            })).map((function(t) {
                                ...
                                servings: +e.servings,
                                ingredients: r
                            }, t.next = 5, Qv("".concat("https://forkify-api.herokuapp.com/api/v2/recipes/", "?key=").concat("a781d6e1-0fbe-47e4-b586-c2eb1c8c7ddc"), n);
                        case 5:
                            o = t.sent, ug.recipe = cg(o), pg(ug.recipe), t.next = 13;
                            break;
                        case 10:
                            throw t.prev = 10, t.t0 = t.catch(0), t.t0;
                        case 13:
                        case "end":
                            return t.stop()
                    }
    ...
    function _g(t, e) {
        ...
        return Sg(wg(bg(t)), bg(e))
    })._dirname = wg, yg._relative = Sg, dg = mg() + yg("31a2d1f951064f7a", "f96e2009a94b89d7");
    var Eg, xg, Og, Ag = (Eg = dg) && Eg.__esModule ? Eg.default : Eg,
        kg = function() {
            function t() {
                var e, r, n;
                ! function(t, e) {
            ...
            return e = t, (r = [{
                ...
                key: "renderSpinner",
                value: function() {
                    var t = '\n      <div class="spinner">\n        <svg>\n          <use href="'.concat(Ag, '#icon-loader"></use>\n        </svg>\n      </div>\n    ');
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._errorMessage,
                        e = '\n      <div class="error">\n        <div>\n          <svg>\n            <use href="'.concat(Ag, '#icon-alert-triangle"></use>\n          </svg>\n        </div>\n        <p>').concat(t, "</p>\n      </div>\n    ");
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._message,
                        e = '\n      <div class="message">\n        <div>\n          <svg>\n            <use href="'.concat(Ag, '#icon-smile"></use>\n          </svg>\n        </div>\n        <p>').concat(t, "</p>\n      </div>\n    ");
                    this._clear(), this._parentElement.insertAdjacentHTML("afterbegin", e)
                }
            }]) && _g(e.prototype, r), n && _g(e, n), t
        }();
    Fraction = function(t, e) {
    ...
    }, Fraction.prototype.normalize = (xg = function(t) {
        ...
        if (xg(this.denominator)) {
            var t = Og(this.denominator, 9),
                e = Math.pow(10, t.toString().split(".")[1].length);
            this.denominator = Math.round(this.denominator * e), this.numerator *= e
        }
        xg(this.numerator) && (t = Og(this.numerator, 9), e = Math.pow(10, t.toString().split(".")[1].length), this.numerator = Math.round(this.numerator * e), this.denominator *= e);
    ...
    function Lg(t, e) {
        return !e || "object" !== Rg(e) && "function" != typeof e ? Fg(t) : e
    }
    ...
    function Ng(t) {
        return (Ng = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) {
    ...
    var Cg = new(function(t) {
        ...
        function i() {
            ...
            return Ug(Fg(t = o.call.apply(o, [this].concat(r))), "_parentElement", document.querySelector(".recipe")), Ug(Fg(t), "_errorMessage", "We could not find that recipe. Please try another one!"), Ug(Fg(t), "_message", ""), t
        }
        return e = i, (r = [{
    ...
    var qg = new(function() {
        ...
        }]) && Dg(e.prototype, r), n && Dg(e, n), t
    }());

    function Bg(t) {
        return (Bg = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            return typeof t
        } : function(t) {
            return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
        })(t)
    ...
    function Hg(t, e) {
        return (Hg = Object.setPrototypeOf || function(t, e) {
            return t.__proto__ = e, t
        })(t, e)
    }
    ...
    function Vg(t, e) {
        return !e || "object" !== Bg(e) && "function" != typeof e ? $g(t) : e
    }
    ...
    function Yg(t) {
        return (Yg = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) {
            return t.__proto__ || Object.getPrototypeOf(t)
        })(t)
    }
    ...
    var Jg = new(function(t) {
        ...
        function i() {
            ...
            zg(this, i);
            for (var e = arguments.length, r = new Array(e), n = 0; n < e; n++) r[n] = arguments[n];
            return Xg($g(t = o.call.apply(o, [this].concat(r))), "_parentElement", ""), t
        }
        return e = i, (r = [{
            key: "_generateMarkup",
            value: function() {
    ...
    function ry(t, e) {
        return !e || "object" !== Kg(e) && "function" != typeof e ? ny(t) : e
    }
    ...
    var ay = new(function(t) {
        ...
        function i() {
            ...
            Qg(this, i);
            for (var e = arguments.length, r = new Array(e), n = 0; n < e; n++) r[n] = arguments[n];
            return iy(ny(t = o.call.apply(o, [this].concat(r))), "_parentElement", document.querySelector(".results")), iy(ny(t), "_errorMessage", "No recipes found for your query! Please try again ;)"), iy(ny(t), "_message", ""), t
        }
        return e = i, (r = [{
            key: "_generateMarkup",
            value: function() {
                return this._data.map((function(t) {
                    return Jg.render(t, !1)
                })).join("")
            }
        }]) && Zg(e.prototype, r), n && Zg(e, n), i
    }(kg));
    ...
    function fy(t, e) {
        return (fy = Object.setPrototypeOf || function(t, e) {
            return t.__proto__ = e, t
        })(t, e)
    }
    ...
    function hy(t, e) {
        return !e || "object" !== uy(e) && "function" != typeof e ? py(t) : e
    }
    ...
    function dy(t) {
        return (dy = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) {
            return t.__proto__ || Object.getPrototypeOf(t)
        })(t)
    }
    ...
    var gy = new(function(t) {
        ...
        function i() {
            ...
            cy(this, i);
            for (var e = arguments.length, r = new Array(e), n = 0; n < e; n++) r[n] = arguments[n];
            return vy(py(t = o.call.apply(o, [this].concat(r))), "_parentElement", document.querySelector(".pagination")), t
        }
        return e = i, (r = [{
            key: "addHandlerClick",
            value: function(t) {
    ...
    function _y(t, e) {
        return !e || "object" !== yy(e) && "function" != typeof e ? Ey(t) : e
    }
    ...
    var Ay = new(function(t) {
        ...
        function i() {
            ...
            my(this, i);
            for (var e = arguments.length, r = new Array(e), n = 0; n < e; n++) r[n] = arguments[n];
            return Oy(Ey(t = o.call.apply(o, [this].concat(r))), "_parentElement", document.querySelector(".bookmarks__list")), Oy(Ey(t), "_errorMessage", "No bookmarks yet. Find a nice recipe and bookmark it ;)"), Oy(Ey(t), "_message", ""), t
        }
        return e = i, (r = [{
            key: "addHandlerRender",
            value: function(t) {
    ...
    function jy(t) {
        return function(t) {
            ...
            "Object" === r && t.constructor && (r = t.constructor.name);
            if ("Map" === r || "Set" === r) return Array.from(t);
            if ("Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return Ry(t, e)
        }(t) || function() {
    ...
    function Iy(t, e) {
        return !e || "object" !== ky(e) && "function" != typeof e ? Ly(t) : e
    }
    ...
    var Uy = new(function(t) {
        ...
        function i() {
            ...
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, i), Ny(Ly(t = o.call(this)), "_parentElement", document.querySelector(".upload")), Ny(Ly(t), "_message", "Recipe was successfully uploaded :)"), Ny(Ly(t), "_window", document.querySelector(".add-recipe-window")), Ny(Ly(t), "_overlay", document.querySelector(".overlay")), Ny(Ly(t), "_btnOpen", document.querySelector(".nav__btn--add-recipe")), Ny(Ly(t), "_btnClose", document.querySelector(".btn--close-modal")), t._addHandlerShowWindow(), t._addHandlerHideWindow(), t
        }
        return e = i, (r = [{
            key: "toggleWindow",
            value: function() {
            ...
            key: "_generateMarkup",
            value: function() {}
        }]) && Py(e.prototype, r), n && Py(e, n), i
    }(kg));

    function Cy(t, e, r, n, o, i, a) {
        try {
            var u = t[i](a),
                c = u.value
        } catch (t) {
    ...
    var qy = function() {
            var t = Dy(regeneratorRuntime.mark((function t() {
                var e;
                return regeneratorRuntime.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 4:
                            return Cg.renderSpinner(), ay.update(lg()), Ay.update(ug.bookmarks), t.next = 9, sg(e);
                        case 9:
                            Cg.render(ug.recipe), t.next = 16;
                            break;
                        case 12:
                            t.prev = 12, t.t0 = t.catch(0), Cg.renderError(), console.error(t.t0);
                        case 16:
                        case "end":
                            return t.stop()
                    }
        ...
        By = function() {
            var t = Dy(regeneratorRuntime.mark((function t() {
                ...
                return regeneratorRuntime.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            if (t.prev = 0, ay.renderSpinner(), e = qg.getQuery()) {
                                t.next = 5;
                                break
                            }
                            return t.abrupt("return");
                        case 5:
                            return t.next = 7, fg(e);
                        case 7:
                            ay.render(lg()), gy.render(ug.search), t.next = 14;
                            break;
                        case 11:
        ...
        zy = function(t) {
            ay.render(lg(t)), gy.render(ug.search)
        },
        Wy = function(t) {
            ! function(t) {
                ug.recipe.ingredients.forEach((function(e) {
                    e.quantity = e.quantity * t / ug.recipe.servings
                })), ug.recipe.servings = t
            }(t), Cg.update(ug.recipe)
        },
        Hy = function() {
            var t, e;
            ug.recipe.bookmarked ? (t = ug.recipe.id, e = ug.bookmarks.findIndex((function(e) {
                return e.id === t
            })), ug.bookmarks.splice(e, 1), t === ug.recipe.id && (ug.recipe.bookmarked = !1), hg()) : pg(ug.recipe), Cg.update(ug.recipe), Ay.render(ug.bookmarks)
        },
        Gy = function() {
            Ay.render(ug.bookmarks)
        },
        Vy = function() {
            var t = Dy(regeneratorRuntime.mark((function t(e) {
                return regeneratorRuntime.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return t.prev = 0, Uy.renderSpinner(), t.next = 4, vg(e);
                        case 4:
                            console.log(ug.recipe), Cg.render(ug.recipe), Uy.renderMessage(), Ay.render(ug.bookmarks), window.history.pushState(null, "", "#".concat(ug.recipe.id)), setTimeout((function() {
                                Uy.toggleWindow()
                            }), 2500), t.next = 16;
                            break;
                        case 12:
                            t.prev = 12, t.t0 = t.catch(0), console.error("💥", t.t0), Uy.renderError(t.t0.message);
                        case 16:
                        case "end":
                            return t.stop()
                    }
    ...
    Ay.addHandlerRender(Gy), Cg.addHandlerRender(qy), Cg.addHandlerUpdateServings(Wy), Cg.addHandlerAddBookmark(Hy), qg.addHandlerSearch(By), gy.addHandlerClick(zy), Uy.addHandlerUpload(Vy)
}();
//# sourceMappingURL=controller.3ea72c78.js.map